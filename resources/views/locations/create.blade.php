...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Create New Location</h1>
            <p class="text-gray-600">Add a new location to track leads from different geographical areas</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow">
        <form action="{{ route('locations.store') }}" method="POST" class="p-6">
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                <a href="{{ route('locations.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-700 px-6 py-2 rounded-lg font-medium transition-colors duration-200">
                    Cancel
                </a>
